...
#define NOTEFREQUENCY 0.001		//frequency of saw wave: f0 = 0.5 * NOTEFREQUENCY * 48000 (=sample rate)
#define NOTEAMPLITUDE 32500.0		//amplitude of the saw wave
	    	...
	    	if (SPI_I2S_GetFlagStatus(CODEC_I2S, SPI_I2S_FLAG_TXE))
	    	    	{
	    	    		...
	    	    		if (sampleCounter & 0x00000001)
	    	    		{
	    	    			...
	    	    			sawWave += 0.05;//weight;//NOTEFREQUENCY;
	    	    			if (sawWave > 1.0)
	    	    				sawWave -= 1.0;
