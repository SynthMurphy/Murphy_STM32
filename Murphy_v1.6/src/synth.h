...
#define BUFF_LEN_DIV4           160//160 	// number of samples <==> 3.3 ms latency at 48kHz
#define BUFF_LEN_DIV2           320//320		// Audio buffer length
#define BUFF_LEN                640//640  	// Audio buffer length for both Left & Right Channels
