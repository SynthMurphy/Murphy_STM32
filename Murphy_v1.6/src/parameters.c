...
uint8_t* PARAMETERS_Start()
{
	...
	GPIO_InitTypeDef  	GPIO_InitStructure;
		...
		USART_InitStructure.USART_BaudRate = 38400;												// MIDI baudrate (31250)
...
void ChangeParam(uint8_t param_number, uint8_t param_value)
{
	switch (param_number)
	{
		...
		case 7 :								// Filter cutoff
		{
			...
			//params.cutoff = (float_t) 1.0f + (2.0f * param_value);
			break;
		}
		...
		{
			params.lfo1_frequency =(float_t) param_value / 10;
			break;
		}
		...
		{
			params.lfo2_frequency =  (float_t) param_value / 10;
			break;
		}
		...
		{
			params.detune = 1.0f + 0.0004f*(param_value-50);
			break;
		}
		case 22 :								// detune osc 2
		{
			params.bend = (param_value-50);
			break;
		}
		case 23 :								// detune osc 2
		{
			params.bend2 = (param_value);
			break;
		}
